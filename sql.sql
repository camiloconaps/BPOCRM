...
-- Volcando datos para la tabla crm_bpo.crmpa_ciud: ~1.120 rows (aproximadamente)
...
-- Volcando datos para la tabla crm_bpo.crmpa_servicio: ~1 rows (aproximadamente)
DELETE FROM `crmpa_servicio`;
/*!40000 ALTER TABLE `crmpa_servicio` DISABLE KEYS */;
INSERT INTO `crmpa_servicio` (`id_serv`, `servicio`, `estado`, `emp_id`) VALUES
	(1, 'OUTBOUND', 1, 1);
